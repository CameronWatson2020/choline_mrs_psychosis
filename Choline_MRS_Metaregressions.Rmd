...
# Use this xls for prefrontal values - not doing currently 
...
# only if you want to do combined PFC - not currently doing 
...
# List our regression variables where we need to change NR to NA - need to include magnet strength as none missing
